"""
Django settings for umschool project.
...
CSRF_TRUSTED_ORIGINS = environ.get('CSRF_TRUSTED_ORIGINS', '').split(',') if environ.get('CSRF_TRUSTED_ORIGINS') else []
...
WSGI_APPLICATION = 'umschool.wsgi.application'
