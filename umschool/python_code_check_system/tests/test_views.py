...
class AddSolutionViewTest(TestCase):
    ...
    def test_solution_submission(self):
        ...
        self.client.login(username='testuser', password='testpass123')
        data = {'source_code': 'print("Hello, World!")', 'task': self.task.id}
        ...
        self.assertEqual(solution.source_code, 'print("Hello, World!")')
...
class SolutionListViewTest(TestCase):
    ...
    def test_only_user_solutions_shown(self):
        ...
        self.assertNotContains(response, 'print("Other solution")')
